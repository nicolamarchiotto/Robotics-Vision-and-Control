function [q,dq,ddq,dddq,ddddq]=copy_of_trajectory_5th_ti_tf(qi,qf,dqi,dqf,ddqi,ddqf,ti,tf,Ts)
%local copy of hw1/trajectory_5th_ti_tf, done simplicity and avoid import
